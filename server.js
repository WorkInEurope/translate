    ...
    req.on('end', () => {
      try {
        ...
        if (parsed.voice === 'fable' || parsed.voice === 'echo' || parsed.voice === 'alloy') {
          parsed.voice = 'onyx';
          // Wrap text with style cue for gravelly foreman delivery
          parsed.input = '[Speak slowly and deliberately, like a weathered construction foreman giving instructions over site noise. Deep, gravelly voice. Brief pauses between phrases.] ' + parsed.input;
        }
